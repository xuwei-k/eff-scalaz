...
def program(ok: Boolean): (Throwable \/ Int, List[Throwable]) =
...
def program(ok: Boolean, finalizeOk: Boolean): (Throwable \/ Int, List[Throwable]) =
...
"""
  def showResult1(message: String, result: (Throwable \/ Int, List[Throwable]), resourceMessage: String, closed: Boolean) =
    result match {
      case (r, ls) =>
        s"""|
  ...
  def showResult2(message: String, result: (Throwable \/ Int, List[Throwable])) =
    result match {
      case (r, ls) =>
        s"""|
